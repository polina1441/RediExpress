...
class OnBoardingAdapter(private val onBoardings: Array<OnBoarding>):
...
data class OnBoarding(val title : String, val text: String, @DrawableRes val img: Int, val viewSignUp: Boolean)